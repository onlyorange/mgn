                ...
                <td>
                  <div class="scrollbox">
                    ...
                    <div class="<?php echo $class; ?>">
                      ...
                      <input type="checkbox" name="pavcustom_module[<?php echo $module_row; ?>][store_id][]" value="<?php echo $store['store_id']; ?>" checked="checked" />
                      <?php echo $store['name']; ?>
                      <?php } else { ?>
                      <input type="checkbox" name="pavcustom_module[<?php echo $module_row; ?>][store_id][]" value="<?php echo $store['store_id']; ?>" />
                      <?php echo $store['name']; ?>
                      <?php } ?>
                    </div>
                    <?php } ?>
...
function addModule() {	
  ...
  html += '         <input <?php echo $checked; ?> type="checkbox" name="pavmap_module[<?php echo $module_row; ?>][store_id][]" value="<?php echo $store["store_id"]; ?>" />';
