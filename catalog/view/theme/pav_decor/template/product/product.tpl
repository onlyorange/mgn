...
<div id="content"><?php echo $content_top; ?>
 ...
 <?php if ($thumb || $images) { ?>
	<div class="span8 image-container">
        ...
        <?php if ($images) { ?>
			<div class="image-additional slide carousel" id="image-additional">
		        ...
		        $total = count($images);
		        ?>
				<div class="carousel-inner" id="zoomLensAreaheight">
		        <?php
		        for ($i = 0; $i < $total; $i++) {
		        ?>
		        <div class="item">
		        	<!--<a href="<?php echo $images[$i]['popup']; ?>" title="<?php echo $heading_title; ?>" class="">-->
						<img style="float:left" width="49%" src="<?php echo $images[$i]['popup']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image"  data-zoom-image="<?php echo $images[$i]['popup']; ?>" class="product-image-zoom"/>
						<?php
						$i++;
						if($i < $total) : 
						?>
							<img width="49%" src="<?php echo $images[$i]['popup']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image"  data-zoom-image="<?php echo $images[$i]['popup']; ?>" class="product-image-zoom"/>
						<?php endif; ?>
					<!--</a>-->
				</div><!-- .item ends -->
			...
			<ol class="carousel-indicators">
				...
				for ($i = 0; $i < $total/2; $i++) { 
				?>
				<li data-target="#image-additional" data-slide-to="<?php echo $i*2; ?>" class="<?php if($i<1) echo 'active';?>"></li>
			    <?php } ?>
			</ol>
			<div id="zoomContain" style="position:absolute; right:15px; top:0;"></div>
          ...
          <script type="text/javascript">
          	...
          	$(function() {
	            ...
	            if($(window).width() > 767) {
		            $('#image-additional').on('slid.bs.carousel', function() {
		            	var zww = document.getElementById("zoomLensAreaWidth").offsetWidth + 27;
		            	var zwh = document.getElementById("zoomLensAreaheight").offsetHeight - 8;
		            	$(zoomCollection).elevateZoom({
					      ...
					      zoomWindowPosition: 'zoomContain',
					      zoomWindowWidth: zww,
          ...
          <style>
          	/*
          	.zoomLens { width:100px !important; height: 50px !important; zoom:3;}
          	*/
          </style>
        <?php } ?>
    ...
    <?php } ?>
    <div class="span4" id="zoomLensAreaWidth">
